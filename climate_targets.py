...
class ClimateMetric(BaseModel):
    ...
    externally_assured: Optional[bool] = None
    ...
    def check_value(self):
        if self.status in {
            ...
            raise ValueError(
                "Reported/calculated/inferred metrics must have a value."
            )
        ...
        if self.status in {
            ...
            raise ValueError(
                "Missing/non-applicable metrics must not contain a value."
            )
...
class GHGEmissions(BaseModel):
    ...
    scope_1_tco2e: Optional[ClimateMetric] = None

    scope_2_market_tco2e: Optional[ClimateMetric] = None

    scope_2_location_tco2e: Optional[ClimateMetric] = None

    scope_3_tco2e: Optional[ClimateMetric] = None

    # ----------------------------
    # OPTIONAL SCOPE 3 BREAKDOWN
    # ----------------------------

    scope_3_purchased_goods_tco2e: Optional[ClimateMetric] = None

    scope_3_capital_goods_tco2e: Optional[ClimateMetric] = None

    scope_3_fuel_energy_tco2e: Optional[ClimateMetric] = None

    scope_3_upstream_transport_tco2e: Optional[ClimateMetric] = None

    scope_3_waste_tco2e: Optional[ClimateMetric] = None

    scope_3_business_travel_tco2e: Optional[ClimateMetric] = None

    scope_3_employee_commuting_tco2e: Optional[ClimateMetric] = None

    scope_3_downstream_transport_tco2e: Optional[ClimateMetric] = None

    scope_3_use_of_sold_products_tco2e: Optional[ClimateMetric] = None

    scope_3_end_of_life_tco2e: Optional[ClimateMetric] = None

    scope_3_leased_assets_tco2e: Optional[ClimateMetric] = None

    scope_3_investments_tco2e: Optional[ClimateMetric] = None
...
class VERDEXClimateData(BaseModel):
    ...
    reported_intensities: list[ClimateIntensity] = Field(
        default_factory=list
    )

    renewable_electricity_pct: Optional[ClimateMetric] = None
    ...
    scope_1_2_change_pct: Optional[ClimateMetric] = None

    scope_3_change_pct: Optional[ClimateMetric] = None

    ghg_intensity_change_pct: Optional[ClimateMetric] = None
    ...
    ghg_inventory_assured: Optional[bool] = None

    assurance_provider: Optional[str] = None

    assurance_level: Optional[
        Literal[
            "limited",
            "reasonable",
            "other"
    ...
    carbon_offsets_tco2e: Optional[ClimateMetric] = None

    carbon_removals_tco2e: Optional[ClimateMetric] = None
    ...
    suppliers_with_science_based_targets_pct: Optional[
        ClimateMetric
    ] = None

    suppliers_engaged_pct: Optional[
        ClimateMetric
    ] = None
    ...
    sector_specific_metrics: list[SectorClimateMetric] = Field(
        default_factory=list
    )
