...
ENVIRONMENTAL_GROUPS = {
    'greenhouse_gas': GreenhouseGas, 'energy': Energy, 'water': Water,
    'waste_circularity': WasteCircularity, 'biodiversity_land': BiodiversityLand,
    'pollution': Pollution, 'targets': Targets,
}


class EnvironmentalObservation(AdditionalObservation):
    group: Literal['greenhouse_gas', 'energy', 'water', 'waste_circularity', 'biodiversity_land', 'pollution', 'targets']
